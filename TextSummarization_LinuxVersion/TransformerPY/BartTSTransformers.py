#PathData = "..//..//data.txt"
#PathResults = "..//..//Results//TF//BartTS.txt"

PathData = "data.txt"
PathResults = "Results/Bart.txt"
...
modelName = 'facebook/bart-large-xsum'
...
translated = model.generate(inputs['input_ids'], num_beams=4,
...
print("--- BartTS %s seconds ---" % (time.time() - start_time))
